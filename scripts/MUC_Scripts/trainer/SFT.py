...
if args.reasoning and not args.natural_reasoning: 
    out_dir = "Model_ReasoningV2"
    run_name = 'SFT_ReasoningV2'
elif args.reasoning and args.natural_reasoning:
    out_dir = "Model_Natural_ReasoningV2"
    run_name = 'SFT_Natural_ReasoningV2'
else:
    out_dir = "Model_JSONV2"
    run_name = 'SFT_JSONV2'
...
data_dev = data['dev']
gradient_acumulation = int((128/(args.batch_size * 4)))
# Define the trainer

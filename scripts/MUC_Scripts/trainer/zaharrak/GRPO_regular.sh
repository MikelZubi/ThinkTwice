...
(
    ...
    taskset -c $MAIN_CPUS accelerate launch --main_process_port 29516 scripts/MUC_Scripts/trainer/GRPO.py --model-path Model_Natural_Reasoning_R1 --distributed --reasoning --natural-reasoning --batch-size 2 --gradient-accumulation-steps 8 --r1
    taskset -c $MAIN_CPUS accelerate launch --main_process_port 29516 scripts/MUC_Scripts/trainer/GRPO.py --model-path Model_Natural_Reasoning --distributed --reasoning --natural-reasoning --batch-size 2 --gradient-accumulation-steps 8 --r1
    taskset -c $MAIN_CPUS accelerate launch --main_process_port 29516 scripts/MUC_Scripts/trainer/GRPO.py --model-path Model_JSON_R1 --distributed --batch-size 4 --gradient-accumulation-steps 4

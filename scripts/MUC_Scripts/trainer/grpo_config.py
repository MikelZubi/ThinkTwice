...
class GRPOConfig(TrainingArguments):
    ...
    vllm_guided_decoding_json: Optional[dict] = field(
        default=None,
        metadata={"help": "JSON for vLLM guided decoding. If `None` (default), guided decoding is disabled."},
    )
    vllm_combine_guided_decoding: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to combine the guided decoding regex and JSON. If set to `True`, the JSON will be "}
    )
    vllm_stop_token_ids: Optional[list[int]] = field(
        default=None,
        metadata={"help": "Stop token IDs for vLLM generation."},
    )

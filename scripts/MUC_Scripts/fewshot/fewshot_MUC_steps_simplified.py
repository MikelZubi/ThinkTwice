...
if random:
    folder_path = "predictions/predictions_MUC_simplified_steps/random-few/"+str(language)

else:
    folder_path = "predictions/predictions_MUC_simplified_steps/first-few/"+str(language)

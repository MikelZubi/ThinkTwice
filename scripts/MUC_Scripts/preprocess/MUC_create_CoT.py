...
for language in languages:
    path_read = "multimuc/data/multimuc_v1.0/corrected/" + language + "/train_simplified_preprocess.jsonl"
    path_write = "multimuc/data/multimuc_v1.0/corrected/" + language + "/train_simplified_CoT.jsonl"
...
for i in range(len(file_paths)):
    ...
    for idx, output in enumerate(result_2):
        pre_dicts[idx]["corrected_reasoning"] = output.outputs[0].text

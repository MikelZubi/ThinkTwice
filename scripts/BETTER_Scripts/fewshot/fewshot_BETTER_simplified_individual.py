    ...
    for k in range(0,61):
        ...
        for guided_decoding_params, class_key in zip(guided_decoding_params_list, class_dict):
            ...
            if class_key == "Displacementplate":
                ...
                if random:
                    folder_path = "predictions/predictions_BETTER_simplified_individuals/random-few/"

                else:
                    folder_path = "predictions/predictions_BETTER_simplified_individuals/first-few/"

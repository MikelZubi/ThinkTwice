...
class Protestplate(BaseModel):
    ...
    protest_against: Optional[list[str]] = Field(
        ...
        default=None)
    protest_event: Optional[list[str]]  = Field(
        description='Triggers of the template',
        default=None) #Unscored
    protest_for: Optional[list[str]] = Field(
    ...
    who: Optional[list[str]] = Field(
        ...
        default=None)
    wounded: Optional[list[str]] = Field(
...
class Corruplate(BaseModel):
    ...
    charged_with: Optional[list[str]] = Field(
        ...
        default=None)
    corrupt_event: Optional[list[str]]  = Field(
        description='Triggers of the template',
        default=None) #Unscored
    judicial_actions: Optional[list[str]] = Field(
        description='Investigations, trials, sentences, and so forth noted in the narrative as having taken place',
        default=None) 
    fine: Optional[list[str]] = Field(
    ...
    outcome_hypothetical: Optional[list[str]] = Field(
        description='Events that are only noted as potentially occurring because of the corruption.',
        default=None) 
    prison_term : Optional[list[str]] = Field(
...
class Terrorplate(BaseModel):
    ...
    blamed_by: Optional[list[str]] = Field(
...
class Disasterplate(BaseModel):
    ...
    major_disaster_event: Optional[list[str]] = Field(
    ...
    when: Optional[list[str]] = Field(
        description='Mentions of times or durations associated with the events involved.',
        default=None)
    injured_count: Optional[list[str]] = Field(
    ...
    killed_count: Optional[list[str]] = Field(
        ...
        default=None)
    missing_count: Optional[list[str]] = Field(
    ...
    damage: Optional[list[str]] = Field(
        ...
        default=None)
    affected_cumulative_count: Optional[list[str]] = Field(
    ...
    disease_outbreak_events: Optional[list[str]] = Field(
        ...
        default=None)
    repair: Optional[list[str]] = Field(
        description='Repair events that are part of the response to the disaster.',
        default=None)
    human_displacement_events: Optional[list[str]] = Field(
...
class Displacementplate(BaseModel):
    ...
    human_displacement_event: Optional[list[str]] = Field(
    ...
    current_location: Optional[list[str]] = Field(
        ...
        default=None)
    transiting_location: Optional[list[str]] = Field(
    ...
    event_or_SoA_at_origin: Optional[list[str]] = Field(
        ...
        default=None)
    settlement_status_event_or_SoA: Optional[list[str]] = Field(
    ...
    outcome: Optional[list[str]] = Field(
        ...
        default=None)
    group_identity: Optional[list[str]] = Field(
...
class indv_Template(BaseModel):
    templates: Protestplate|Corruplate|Terrorplate|Epidemiplate|Disasterplate|Displacementplate = Field(discriminator='template_type')

...
from iterx.metrics.muc.gtt_eval_utils import read_gold_templates, add_normalized_templates, read_gold_templates_list
...
class IterXMUCMetric(Metric):
    def __init__(self,
                 doc_path: Union[Dict[str, str],Dict[str, List]],
        ...
        if doc_path is not None:
            ...
            for src_file, ref in doc_path.items():
                ...
                if not compute_metrics:
                    ...
                    ref_data = ref
                    self.references[src_file] = read_gold_templates_list(ref_data,
                                                                    convert_doc_id=convert_doc_id,
                                                                    sanitize_special_chars=sanitize_special_chars)

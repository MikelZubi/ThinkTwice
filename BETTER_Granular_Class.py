...
class Protestplate(BaseModel):
    ...
    over_time: Optional[bool] = Field(
        ...
        default=None)
    organizer: Optional[list[span_set]] = Field(
        description='The group/individuals leading the protest, e.g., "the Workers Party".',
        default=None)
    outcome_averted: Optional[list[span_set|event_set]] = Field(
        ...
        default=None)
    outcome_occurred: Optional[list[span_set|event_set]] = Field(
        description='Events that occurred because of the corruption.',
        default=None)
    outcome_hypothetical: Optional[list[span_set|event_set]] = Field(
        description='Events that are only noted as potentially occurring because of the corruption.',
        default=None)
    protest_against: Optional[list[span_set|event_set]] = Field(
        ...
        default=None)
    protest_event: Optional[list[span_set|event_set]]  = Field(
        description='Triggers of the template',
        default=None) #Unscored
    protest_for: Optional[list[span_set|event_set]] = Field(
...
class Corruplate(BaseModel):
    ...
    charged_with: Optional[list[span_set|event_set]] = Field(
        ...
        default=None)
    corrupt_event: Optional[list[span_set|event_set]]  = Field(
        description='Triggers of the template',
        default=None) #Unscored
    judicial_actions: Optional[list[span_set|event_set]] = Field(
        description='Investigations, trials, sentences, and so forth noted in the narrative as having taken place',
        default=None) 
    fine: Optional[list[span_set]] = Field(
    ...
    over_time: Optional[bool] = Field(
        ...
        default=None) 
    outcome_averted: Optional[list[span_set]] = Field(
        description='Events that were either averted or are noted as not having occurred, e.g., “no injuries” (Basic events do not code negation or other realis factors).',
        default=None) 
    outcome_occurred: Optional[list[span_set|event_set]] = Field(
        description='Events that occurred because of the corruption.',
    ...
    outcome_hypothetical: Optional[list[span_set|event_set]] = Field(
        description='Events that are only noted as potentially occurring because of the corruption.',
        default=None) 
    prison_term : Optional[list[span_set]] = Field(
...
class Terrorplate(BaseModel):
    ...
    blamed_by: Optional[list[span_set]] = Field(
        description='Those who are asserting the identity of the perpetrators.',
        default=None) 
    claimed_by: Optional[list[span_set]] = Field(
    ...
    type: Optional[Literal["arson", "assault", "bombing", "kidnapping", "murder", "unspecified"]] = Field(
        ...
        default=None)
    weapon: Optional[list[span_set]] = Field(
...
class Disasterplate(BaseModel):
    ...
    major_disaster_event: Optional[list[span_set|event_set]] = Field(
    ...
    when: Optional[list[span_set]] = Field(
        description='Mentions of times or durations associated with the events involved.',
        default=None)
    injured_count: Optional[list[span_set]] = Field(
    ...
    outcome: Optional[list[event_set]] = Field(
        ...
        default=None)
    responders: Optional[list[span_set]] = Field(
        description='Entities designating the responders to the natural disaster.',
        default=None)
    damage: Optional[list[span_set]] = Field(
        ...
        default=None)
    affected_cumulative_count: Optional[list[span_set]] = Field(
    ...
    disease_outbreak_events: Optional[list[event_set]] = Field(
        ...
        default=None)
    repair: Optional[list[event_set]] = Field(
        description='Repair events that are part of the response to the disaster.',
        default=None)
    human_displacement_events: Optional[list[event_set]] = Field(
...
class Displacementplate(BaseModel):
    ...
    human_displacement_event: Optional[list[event_set]] = Field(
    ...
    event_or_SoA_at_origin: Optional[list[event_set]] = Field(
        ...
        default=None)
    settlement_status_event_or_SoA: Optional[list[event_set]] = Field(
    ...
    outcome: Optional[list[event_set]] = Field(
        ...
        default=None)
    group_identity: Optional[list[span_set]] = Field(
